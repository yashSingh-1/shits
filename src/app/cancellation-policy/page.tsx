      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mt-4">
            ...
            <li>In case of receipt of damaged or defective items please report the same to our Customer Service team.</li>
            <li>The request will, however, be entertained once the merchant has checked and determined the same at his own end.</li>
            <li>This should be reported within of receipt of the products.</li>
