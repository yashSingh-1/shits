      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <section>
          ...
          <p className="text-gray-300">
            This privacy policy sets out how Kadala uses and protects any information that you give Kadala when you use this website. 
            Kadala is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which 
            you can be identified when using this website, and then you can be assured that it will only be used in accordance with 
            this privacy statement. Kadala may change this policy from time to time by updating this page. You should check this page 
        ...
        <section>
          ...
          <p className="text-gray-300 mb-4">We require this information to understand your needs and provide you with a better service, and in particular for the following reasons:</p>
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
        ...
        <section>
          ...
          <p className="text-gray-300 mt-4">
            ...
            as soon as possible, at the above address. We will promptly correct any information found to be incorrect.
          </p>
        </section>
      </div>
    </div>
